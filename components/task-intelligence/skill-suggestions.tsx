...
import { presetQuestionFromDescription } from "@/lib/prompts";
...
/** 预设问题统一入口：基于真实 description / usage 生成（模板在 lib/prompts.ts） */
const presetQuestion = presetQuestionFromDescription;
